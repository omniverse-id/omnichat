...
export function ThemeController() {
    ...
    () => (
      <div className="flex gap-2 items-center ml-2">
        <span
          ...
          className="bg-card grid shrink-0 grid-cols-2 gap-1 rounded-md p-1 shadow-sm"
        >
  ...
  const renderThemeOption = (option: DropdownOption) => (
    <div className="flex gap-2 items-center">
      <span
        ...
        className="bg-card grid shrink-0 grid-cols-2 gap-0.5 rounded-md p-1 shadow-sm"
      >
        <div className="bg-foreground size-1 rounded-full"></div>{' '}
        <div className="bg-primary size-1 rounded-full"></div>{' '}
        <div className="bg-secondary size-1 rounded-full"></div>{' '}
  ...
  /* theme controller for data and syntax themes */
  return (
    <>
      {/* UI theme */}
      <div className="flex flex-col justify-center mb-3">
        ...
        <Label variant="input-bordered" className="mb-1 rounded-md">
